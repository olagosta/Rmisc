#' @title similarity
#'
#' @description Computes similarity coefficient for two binary variables.
#'
#' @param i,j Vectors of same length with binary values (eg 0/1, "N"/"P", FALSE/TRUE).
